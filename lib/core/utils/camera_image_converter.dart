...
class CameraImageConverter {
  ...
  //       convertedImage.setPixel(iCol + j, iRow, img.getColor(r, g, b));
  //     }
  //     //Set color for y2, y3
  //     for (int j = 0; j < 2; j++) {
  ...
  //       convertedImage.setPixel(iCol + j, iRow + 1, img.getColor(r, g, b));
  //     }
  //   }
  //   return Uint8List.fromList(convertedImage.getBytes());
  // }
  //
  // static List<int> convertCameraImageToPNG(CameraImage image) {
  //   // final convertedData = convertNV21toRGBA(image);
  //   // Convert the RGBA image to PNG
  //   // final pngBytes = img.encodePng(
  //   //     img.Image.fromBytes(image.width, image.height, convertedData));
  //   // return pngBytes;
  ...
  //       convertedImage = convertBGRA8888ToPNG(image);
  ...
  //       // Convert to png
  //       png = pngEncoder.encodeImage(convertedImage);
  //     }
  //   } catch (e) {
  //     // ShowPopup.showDialogNotification(e.toString());
  //   }
  //   return png;
  // }
  //
  ...
  // // Color
  // static img.Image convertBGRA8888ToPNG(CameraImage image) {
  ...
  // //   final Uint8List convertedData = convertNV21toRGBA(image);
  // //   final String base64Bytes = base64Encode(convertedData);
  // //   return base64Bytes;
  // // }
  //
