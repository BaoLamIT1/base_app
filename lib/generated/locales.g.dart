...
class LocaleKeys {
  ...
  static const login_logInWrongPassword = 'login_logInWrongPassword';
  static const login_accountNotExist = 'login_accountNotExist';
  static const login_accountEmpty = 'login_accountEmpty';
  static const login_passwordEmpty = 'login_passwordEmpty';
  static const login_incorrectEmailFormat = 'login_incorrectEmailFormat';
  static const login_passwordMustBeAtLeast8Characters =
      'login_passwordMustBeAtLeast8Characters';
  static const login_passwordMustContainAtLeastOneUppercaseLetter =
      'login_passwordMustContainAtLeastOneUppercaseLetter';
  static const login_passwordMustContainAtLeastOneLowercaseLetter =
      'login_passwordMustContainAtLeastOneLowercaseLetter';
  static const login_passwordMustContainAtLeastOneNumber =
      'login_passwordMustContainAtLeastOneNumber';
  static const login_passwordMustContainAtLeastOneSpecialCharacter =
  ...
  static const concentration_classification = 'concentration_classification';
  static const concentration_violation = 'concentration_violation';
  static const concentration_behavior = 'concentration_behavior';
  static const concentration_detail = 'concentration_detail';
  static const concentration_morning = 'concentration_morning';
  static const concentration_afternoon = 'concentration_afternoon';
  static const concentration_usePhone = 'concentration_usePhone';
  static const concentration_raiseHand = 'concentration_raiseHand';
  static const concentration_leaveSeat = 'concentration_leaveSeat';
  static const concentration_dozeOff = 'concentration_dozeOff';
  static const concentration_normal = 'concentration_normal';
  static const concentration_talk = 'concentration_talk';
  static const webSocket_noDataTimeKeeping = 'webSocket_noDataTimeKeeping';
  static const webSocket_cantSendNotificationTimeKeeping =
      'webSocket_cantSendNotificationTimeKeeping';
  static const biometric_biometricChanged = 'biometric_biometricChanged';
  static const biometric_loginWithPassword = 'biometric_loginWithPassword';
  static const biometric_biometricRequireRemember =
      'biometric_biometricRequireRemember';
  static const biometric_biometricIsDisabled = 'biometric_biometricIsDisabled';
  static const biometric_logInByBiometric = 'biometric_logInByBiometric';
  static const biometric_biometricFailed = 'biometric_biometricFailed';
  ...
  static const biometric_noAccountSaved = 'biometric_noAccountSaved';
  static const language_countryCode = 'language_countryCode';
  static const language_language = 'language_language';
  static const language_language_vietnamese = 'language_language_vietnamese';
  static const language_language_english = 'language_language_english';
  static const language_selectLanguageSuccess =
      'language_selectLanguageSuccess';
  static const editInformation_editInformation =
      'editInformation_editInformation';
  static const editInformation_editFailure = 'editInformation_editFailure';
  static const editInformation_complete = 'editInformation_complete';
  static const editInformation_enterDob = 'editInformation_enterDob';
  static const editInformation_enterEmail = 'editInformation_enterEmail';
  static const editInformation_enterParentName =
      'editInformation_enterParentName';
  static const editInformation_enterPhoneNumber =
      'editInformation_enterPhoneNumber';
  static const editInformation_enterAddress = 'editInformation_enterAddress';
  static const editInformation_currentPassword =
      'editInformation_currentPassword';
  static const editInformation_errorPhoneNumberType =
      'editInformation_errorPhoneNumberType';
  static const editInformation_changePasswordRequire =
...
class Locales {
  static const en_US = {
    ...
    'login_logInWrongPassword': 'Log in wrong password',
    'login_accountNotExist': 'Account not exist',
    'login_accountEmpty': 'Account cannot be empty',
    'login_passwordEmpty': 'Password cannot be empty',
    'login_incorrectEmailFormat': 'Incorrect email format',
    'login_passwordMustBeAtLeast8Characters':
    ...
    'concentration_violation': 'Violation',
    'concentration_behavior': 'Behavior',
    'concentration_detail': 'Detail',
    'concentration_morning': 'Morning',
    'concentration_afternoon': 'Afternoon',
    'concentration_usePhone': 'Phone usage',
    'concentration_raiseHand': 'Raise hand',
    'concentration_leaveSeat': 'Leave seat',
    'concentration_dozeOff': 'Dozed off',
    'concentration_normal': 'Normal',
    'concentration_talk': 'Talk',
    'webSocket_noDataTimeKeeping': 'No timekeeping data available',
    'webSocket_cantSendNotificationTimeKeeping':
        'Cannot send timekeeping notification',
    'biometric_biometricChanged':
        'Your fingerprint or Face ID has changed. Please log in using your username and password.',
    'biometric_loginWithPassword': 'Log in with Password',
    'biometric_biometricRequireRemember': 'Biometric require remember account',
    'biometric_biometricIsDisabled': 'Biometric is disabled',
    'biometric_logInByBiometric': 'Log in with biometric',
    'biometric_biometricFailed': 'Biometric authentication failed',
    'biometric_authenticationTitle': 'Please scan your fingerprint',
    'biometric_cancelButton': 'Cancel',
    'biometric_setting': 'Settings',
    'biometric_authenticationContent':
        'Please set up fingerprint authentication',
    'biometric_lockout': 'Please enable fingerprint security',
    'biometric_authentication': 'Authentication',
    'biometric_authenticationSuccess': 'Authentication successful',
    'biometric_authenticationError': 'Invalid fingerprint',
    'biometric_noAuthenticationError':
        'You have not set up any authentication method! Please set up an authentication method to continue using. Invalid fingerprint',
    'biometric_msgUnavailable':
        'Please exit the app and set up a machine password or fingerprint to use the password-saving feature!',
    'biometric_msgLimit':
        'You have made too many failed attempts. Please try again later!',
    'biometric_noteSettingBiometricFace':
        'You have not set up face login. Please log in with a password and set up face authentication.',
    'biometric_noteSettingBiometricFingerprint':
        'You have not set up fingerprint login. Please log in with a password and set up fingerprint authentication.',
    'biometric_noAccountSaved': 'No account saved',
    'language_countryCode': 'EN',
    'language_language': 'Languages',
    'language_language_vietnamese': 'Vietnamese',
    'language_language_english': 'English',
    'language_selectLanguageSuccess': 'Language changed successfully',
    'editInformation_editInformation': 'Edit information',
    'editInformation_editFailure': 'Edit failure',
    'editInformation_complete': 'Complete',
    'editInformation_enterDob': 'Select date of birth',
    'editInformation_enterEmail': 'Enter email',
    'editInformation_enterParentName': 'Enter parent\'s name',
    'editInformation_enterPhoneNumber': 'Enter phone number',
    'editInformation_enterAddress': 'Enter address',
    'editInformation_currentPassword': 'Current password',
    'editInformation_errorPhoneNumberType': 'Error phone number type',
    'editInformation_changePasswordRequire':
  ...
  static const vi_VN = {
    ...
    'app_today': 'Hôm nay',
    'app_yesterday': 'Hôm qua',
    'app_checkIn_success': 'Điểm danh thành công',
    'app_time_in': 'Giờ vào',
    'app_time_out': 'Giờ ra',
    'app_time': 'Giờ',
    'app_in': 'vào',
    'app_out': 'ra',
    'app_instruct_liveness': 'Hướng dẫn Liveness',
    'app_LivenessGuideTitle': 'Hướng dẫn sử dụng tính năng Liveness',
    'app_LivenessStartHint': 'Bấm vào nút BẮT ĐẦU để tiến hành quét',
    'app_LivenessStepHint':
        'Định vị khuôn mặt của bạn đặt trong khung hình định sẵn, sau đó thực hiện 5 hành vi trên màn hình',
    'app_LivenessNote':
        '*Lưu ý: Đảm bảo đầy đủ ánh sáng, không có vật thể (kính, khẩu trang) che trước mặt trong quá trình Liveness',
    'app_start': 'Bắt đầu',
    'app_birthday': 'Ngày sinh',
    'app_gender': 'Giới tính',
    'app_cccd': 'Số CCCD',
    'app_information_parents': 'Thông tin PHHS',
    'app_phone_parents': 'Số điện thoại PHHS',
    'app_fullName': 'Họ tên',
    'app_nameAccount': 'Tên tài khoản',
    'app_resetPassword': 'Đổi mật khẩu',
    'app_individual': 'Cá nhân',
    'app_TurnLeftFace': 'Quay trái',
    'app_TurnRightFace': 'Quay phải',
    'app_faceUp': 'Ngửa mặt lên',
    'app_faceDown': 'Gật đầu xuống',
    'app_between': 'Nhìn thẳng',
    'app_blink': 'Nháy mắt',
    'app_smileAction': 'Cười',
    'app_undefined': 'Undefined',
    'app_TurnLeftFaceTitle': 'Vui lòng đưa mặt sang trái',
    'app_TurnRightFaceTitle': 'Vui lòng đưa mặt sang phải',
    'app_faceUpTitle': 'Vui lòng ngửa mặt lên',
    'app_faceDownTitle': 'Vui lòng cúi mặt xuống',
    'app_betweenTitle': 'Vui lòng nhìn thẳng',
    'app_blinkTitle': 'Vui lòng nháy mắt',
    'app_smileTitle': 'Vui lòng cười',
    'app_cameraInitializing': 'Đang khởi tạo camera...',
    'app_cameraInitializeError': 'Lỗi khởi tạo camera',
    'app_second': 'giây',
    'app_startFace': 'Nhìn thẳng vào màn hình',
    'app_successFace': 'Xác thực thành công',
    'app_errorFace': 'Xác thực thất bại',
    'app_waitingFace': 'Vui lòng chờ',
    'app_hintFaceIDOne1': '1.Bấm vào nút',
    'app_hintFaceIDOne2': ' BẮT ĐẦU ',
    'app_hintFaceIDOne3': 'để tiến hành quét',
    'app_hintFaceIDTwo':
        '2.Định vị khuôn mặt ở trong khung hình camera được chỉ định. Và hoàn thành 5 thao tác như hướng dẫn. ',
    'app_hintFaceIDThree': '3.Chờ đến khi quá trình kết thúc và hoàn thành',
    'app_titleCheckFaceId': 'Hướng dẫn quét Face ID',
    'app_titleAuthentic': 'Xác thực khuôn mặt',
    'app_face_id_live': 'Thực hiện quét Face ID',
    'app_hintFaceIDTwo1':
        '2.Định vị khuôn mặt ở trong khung hình camera được chỉ định. Và hoàn thành 5 thao tác như hướng dẫn.',
    'app_hintFaceIDThree1': '3.Chờ đến khi quá trình kết thúc và hoàn thành',
    'app_titleCheckFaceId1': 'Hướng dẫn quét Face ID',
    'app_face_empty': 'Khuôn mặt không nằm trong khung hình',
    'app_many_face': 'Quá nhiều khuôn mặt nằm trong khung hình',
    'app_not_smile_face': 'Vui lòng không cười',
    'app_live_ness_action':
        'Hãy định vị khuôn mặt của bạn trong khung chỉ định, quá trình sẽ tự động bắt đầu khi nhận diện được khuôn mặt',
    'app_live_ness_action1':
        'Hãy định vị khuôn mặt của bạn vào vị trí camera, và thực hiện các hành vi theo chỉ dẫn',
    'app_profileFaceID': 'Xác thực khuôn mặt',
    'app_complete_identification': 'Hoàn tất nhận diện',
    'app_fullName1': 'Họ và tên:',
    'app_EnterFullName1': 'Nhập họ và tên',
    'app_studentId': 'Mã HSSV',
    'app_EnterStudentId': 'Nhập mã HSSV',
    'app_classUnit': 'Đơn vị lớp:',
    'app_EnterClassUnit': 'Nhập đơn vị lớp',
    'app_grade': 'Khối',
    'app_class': 'Lớp',
    'app_retake': 'Chụp lại',
    'app_addNew': 'Thêm mới',
    'app_loginFailed': 'Đăng nhập không thành công',
    'app_Attention': 'Chú ý',
    'app_personalProfile': 'Hồ sơ cá nhân',
    'app_accountInformation': 'Thông tin tài khoản',
    'app_male': 'Nam',
    'app_female': 'Nữ',
    'app_addFaceSuccess': 'Thêm khuôn mặt thành công',
    'app_addFaceFailed': 'Thêm khuôn mặt thất bại',
    'app_errorProcessingImage': 'Lỗi khi xử lý ảnh',
    'app_noImageDataAvailable': 'Không có dữ liệu ảnh nào',
    'app_noHistoryAttendanceFound': 'Chưa có lịch sử điểm danh',
    'app_logoutTitle': 'Bạn có chắc muốn đăng xuất không?',
    'app_logout': 'Đăng xuất',
    'app_timekeepingSuccess': 'Chấm công thành công',
    'app_timekeepingFailed': 'Chấm công thất bại',
    'app_youHaveSuccessfullyTimekeepingOn':
        'Bạn đã chấm công thành công vào lúc',
    'app_youHaveSuccessfullyTimekeepingOut':
        'Bạn đã chấm công thành công ra lúc',
    'app_concentrationLevel': 'Mức độ tập trung',
    'app_timetable': 'Thời khóa biểu',
    'app_officialClass': 'Lớp chính thức',
    'app_supplementaryClass': 'Lớp bồi dưỡng',
    'app_dozedOff': 'Ngủ gật:',
    'app_raiseHand': 'Giơ tay phát biểu:',
    'app_usingPhone': 'Sử dụng ĐT:',
    'app_goOutDuringClass': 'Ra ngoài trong giờ học:',
    'app_absent': 'Nghỉ:',
    'app_late_early': 'Đi muộn/Về sớm:',
    'app_Monday': 'Th2',
    'app_Tuesday': 'Th3',
    'app_Wednesday': 'Th4',
    'app_Thursday': 'Th5',
    ...
    'login_logInWrongPassword': 'Sai password, vui lòng thử lại!',
    'login_accountNotExist': 'Tài khoản không tồn tại',
    'login_accountEmpty': 'Tài khoản không được để trống',
    'login_passwordEmpty': 'Mật khẩu không được để trống',
    'login_incorrectEmailFormat': 'Email không đúng định dạng',
    'login_passwordMustBeAtLeast8Characters': 'Mật khẩu ít nhất 8 ký tự',
    'login_passwordMustContainAtLeastOneUppercaseLetter':
    ...
    'login_changeAccount': 'Thay đổi tài khoản',
    'login_changeAccountConfirm': 'Bạn xác nhận thay đổi tài khoản ?',
    'login_productOfLamBaoBao': 'Sản phẩm của LamBaoBao',
    'concentration_behaviorCompositeScore': 'Điểm hành vi',
    'concentration_individualConcentrationLevel': 'Điểm tập trung',
    'concentration_classification': 'Phân loại',
    'concentration_violation': 'Vi phạm',
    'concentration_behavior': 'Hành vi',
    'concentration_detail': 'Chi tiết',
    'concentration_morning': 'Buổi sáng',
    'concentration_afternoon': 'Buổi chiều',
    'concentration_usePhone': 'Sử dụng điện thoại',
    'concentration_raiseHand': 'Giơ tay',
    'concentration_leaveSeat': 'Rời chỗ',
    'concentration_dozeOff': 'Ngủ gật',
    'concentration_normal': 'Bình thường',
    'concentration_talk': 'Nói chuyện riêng',
    'webSocket_noDataTimeKeeping': 'Không có thông tin chấm công',
    'webSocket_cantSendNotificationTimeKeeping':
        'Không thể gửi thông báo chấm công',
    'biometric_biometricChanged':
        'Dấu vân tay hoặc Face ID của bạn đã thay đổi. Vui lòng đăng nhập bằng tên người dùng và mật khẩu của bạn.',
    'biometric_loginWithPassword': 'Đăng nhập bằng mật khẩu',
    'biometric_biometricRequireRemember':
        'Xác thực sinh học yêu cầu ghi nhớ tài khoản',
    'biometric_biometricIsDisabled': 'Xác thực sinh trắc học chưa được bật',
    'biometric_logInByBiometric': 'Đăng nhập bằng sinh trắc học',
    'biometric_biometricFailed': 'Xác thực sinh trắc học thất bại',
    ...
    'biometric_noteSettingBiometricFace':
        'Quý khách chưa cài đặt đăng nhập bằng khuôn mặt. Vui lòng đăng nhập vào tài khoản bằng mật khẩu và cài đặt xác thực khuôn mặt',
    'biometric_noteSettingBiometricFingerprint':
        'Quý khách chưa cài đặt đăng nhập bằng vân tay. Vui lòng đăng nhập vào tài khoản bằng mật khẩu và cài đặt xác thực vân tay',
    'biometric_noAccountSaved': 'Không có tài khoản nào được lưu',
    'language_countryCode': 'VN',
    'language_language': 'Ngôn ngữ',
    'language_language_vietnamese': 'Tiếng Việt',
    'language_language_english': 'Tiếng Anh',
    'language_selectLanguageSuccess': 'Thay đổi ngôn ngữ thành công',
    'editInformation_editInformation': 'Chỉnh sửa thông tin',
    'editInformation_editFailure': 'Chỉnh sửa thất bại',
    'editInformation_complete': 'Hoàn tất',
    'editInformation_enterDob': 'Chọn ngày sinh',
    'editInformation_enterEmail': 'Nhập email',
    'editInformation_enterParentName': 'Nhập họ tên PHHS',
    'editInformation_enterPhoneNumber': 'Nhập số điện thoại',
    'editInformation_errorPhoneNumberType': 'Sai định dạng số điện thoại',
    'editInformation_enterAddress': 'Nhập địa chỉ',
    'editInformation_currentPassword': 'Mật khẩu hiện tại',
    'editInformation_changePasswordRequire':
